  ...
  <xsl:template match="/">
    <html xmlns="http://www.w3.org/1999/xhtml">
      <head>
        ...
        <link type="text/css" rel="stylesheet" href="http://example.org/css/styles.9e0c9c20c9de135fbf0d1a5e35f3f000c7d58d3e9c6c89a28a4949621de4cbcc35d02d24302c1f51fce25617455fa140b0db092dc2efcbae1ccee93a5e8a6b65.css" integrity="sha512-ngycIMneE1+/DRpeNfPwAMfVjT6cbImiiklJYh3ky8w10C0kMCwfUfziVhdFX6FAsNsJLcLvy64czuk6XoprZQ==" />
        <style>
          .aboutfeeds {
      ...
      <body>
        <header>
          ...
          <div class="head">
            <div class="avatar">
              <img class="logo" src="/logo2.png" alt="Site Logo"/>
            </div>
